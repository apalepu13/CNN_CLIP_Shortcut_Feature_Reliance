...
def main(args):
    ...
    for epoch in range(start, args.num_epochs):
        ...
        if epoch % args.val_step == 0:
            je_model.eval()
            tval = time.time()
            val_loss = validate(device, val_data_loader_mimic, tokenizer, je_model, source="MIMIC")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='/n/data2/hms/dbmi/beamlab/anil/CNN_CLIP_Shortcut_Feature_Reliance/models/je_model/', help='path for saving trained models')
